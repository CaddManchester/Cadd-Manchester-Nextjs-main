  ...
  return (
    <>
      ...
      >
        ...
        We’re crafting something great behind the scenes — launching soon!
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-2xl mx-auto text-center animate-fade-up">
          ...
          <p className="text-sm text-gray-500 mb-6">
            We're working hard to bring you something awesome. Meanwhile, feel free to explore the rest of our site.
          </p>
          <Link
            href="/"
