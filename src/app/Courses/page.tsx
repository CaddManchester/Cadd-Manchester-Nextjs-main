...
const CoursesPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50 text-gray-800 pt-[150px]">
      {/* Sidebar: Course List */}
      <aside className="w-full md:w-1/3 bg-white shadow-md md:sticky md:top-[80px] md:h-[calc(100vh-80px)] overflow-y-auto p-6">
